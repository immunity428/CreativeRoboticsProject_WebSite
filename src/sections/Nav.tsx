      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div
              style={{ fontSize: 9, color: T.primary, letterSpacing: '0.2em' }}
            >
              ROBOT CREATIVE LAB
            </div>
          </div>
          ...
          {links.map((l) => {
            ...
            return (
              <span
                ...
                style={{
                  cursor: 'pointer',
                  fontWeight: isActivePage ? 800 : 500,
                  color: isActivePage ? T.primary : T.textMute,
                  padding: l.kind === 'page' ? '4px 10px' : 0,
                  borderRadius: l.kind === 'page' ? 999 : 0,
                  border:
                    l.kind === 'page'
                      ? `1px solid ${isActivePage ? T.primary : T.border}`
                      : 'none',
                  background: isActivePage ? `${T.primary}15` : 'transparent',
                  transition: 'all 0.2s',
                }}
              >
                {l.label}
            ...
            return (
              <div
                ...
                style={{
                  padding: '16px 24px',
                  fontSize: 15,
                  fontWeight: isActivePage ? 800 : 600,
                  color: isActivePage ? T.primary : T.text,
                  borderBottom: `1px solid ${T.border}`,
                  cursor: 'pointer',
                  background: isActivePage ? `${T.primary}10` : 'transparent',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'space-between',
                }}
